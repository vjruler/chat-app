...
class User extends BaseModel {
    ...
    public function rules() {
        return array(
            ...
            array('name', 'match', 'pattern' => '/^[a-z][a-z0-9_]+$/i', 'message' => 'Wrong nickname. It should consist of letters, Digits and underscores'),
            array('name', 'unique', 'message' => 'Nick is already taken'),
            ...
            array('password_new', 'compare', 'allowEmpty' => true, 'message' => 'Passwords do not match'),
            array('reg_date,photo,twitter_id,password', 'unsafe'),
            array('name, reg_date', 'required', 'on' => 'insert,edit', 'message' => 'Fill in the form'),
            array('password_new_repeat, password_new', 'required', 'on' => 'insert', 'message' => 'Fill in the form'),
        );
    }
